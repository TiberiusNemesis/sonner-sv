...
<div class="wrapper">
	...
	<h1 class="heading">Sonner</h1>
	<p class="tagline">An opinionated toast component for Svelte.</p>
	<div class="buttons">
		<button
			data-primary=""
			class="button"
			onclick={() => toast('Sonner', { description: 'An opinionated toast component for Svelte.' })}
		>
			Render a toast
		</button>
		<a class="button" href={REPO_URL} target="_blank">GitHub</a>
	</div>
	<a href="{REPO_URL}#readme" class="link">Documentation</a>
</div>
